...
function printRandomPopImg() {
    var populist_imgs = [
        ...
        `<img src = "populist_images/nyt rutte.png" alt = "NYT 2017 (https://www.nytimes.com/2017/01/24/world/europe/mark-rutte-netherlands-muslim-immigrants-trump.html): Netherlands' Mark Rutte Takes a Trump-Like Turn">`,
        ...
        `<img src = "populist_images/wapo rutte 2017.png" alt = "Washington Post 2017: Mark Rutte to immigrants: Act normal or leave">`,
        `<img src = "populist_images/fetzer 2019 vote leave vote ukip geography.png" alt = "Fetzer 2019: Geography of Vote Leave, UK">`,
        `<img src = "populist_images/broz et al 2021 trump performance 2016 vote share over romney 2012.png" alt = "Broz et al. 2021: Trump performance, 2016, over Romney, 2012">`,
        `<img src = "populist_images/margalit et al 2022 p20 rise of right populist parties 1960 2020.png" alt = "Margalit et al. 2022: Rise of right populist parties 1960-2020">`,
