...
function printRandomPopImg() {
    var populist_imgs = [
        ...
        `<img src = "populist_images/new labour mug 1 buzzfeed.jpg" alt = "Buzzfeed: New Labour campaign mugs, 1997">`,
        ...
        `<img src = "populist_images/campaign live which party will use outdoor most effectively 2015.jpg" alt = "CampaignLive: Conservative ad defaced, UK 2015">`,
        `<img src = "populist_images/nyt rutte.jpg" alt = "NYT 2017 (https://www.nytimes.com/2017/01/24/world/europe/mark-rutte-netherlands-muslim-immigrants-trump.html): Netherlands' Mark Rutte Takes a Trump-Like Turn">`,
        ...
        `<img src = "populist_images/wapo rutte 2017.jpg" alt = "Washington Post 2017: Mark Rutte to immigrants: Act normal or leave">`,
        `<img src = "populist_images/fetzer 2019 vote leave vote ukip geography.jpg" alt = "Fetzer 2019: Geography of Vote Leave, UK">`,
        `<img src = "populist_images/broz et al 2021 trump performance 2016 vote share over romney 2012.jpg" alt = "Broz et al. 2021: Trump performance, 2016, over Romney, 2012">`,
        `<img src = "populist_images/margalit et al 2022 p20 rise of right populist parties 1960 2020.jpg" alt = "Margalit et al. 2022: Rise of right populist parties 1960-2020">`,
        `<img src = "populist_images/rhodes purdy et al 2023 p11 spread and intensification of discontentment parties.jpg" alt = "Rhodes-Purdy et al. 2023: Rise of discontentment parties">`,
        ...
        `<img src = "populist_images/florianbasedmortimer rain epler.jpg" alt = "Twitter (@BasedMortimer) 2023 (https://twitter.com/BasedMortimer/status/1632461155988918276): Right-nationalist Rainn Epler, Estonia">`
    ];
